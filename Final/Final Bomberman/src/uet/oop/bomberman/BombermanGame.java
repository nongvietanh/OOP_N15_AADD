...
import uet.oop.bomberman.keyhandle.KeyHandle;
...
public class BombermanGame extends Application {
    ...
    public void start(Stage stage) {
        ...
        try {
            audio.audioUpdate("C:\\Users\\Nong Duc Viet Anh\\Desktop\\Bomberman_AADD\\Final\\Final Bomberman\\res\\sound\\BlueBoyAdventure.wav",-1);
                ...
                if (delta >= 1) {
                    if (!isRun) {
                        ...
                        if (timeNumber < 0 || !isLife){
                            Menu.GameOver(root);
                            try {
                                audio.audioUpdate("C:\\Users\\Nong Duc Viet Anh\\Desktop\\Bomberman_AADD\\Final\\Final Bomberman\\res\\sound\\just_died.wav",0);
                            } catch (UnsupportedAudioFileException e) {
                                e.printStackTrace();
                            } catch (IOException e) {
                                e.printStackTrace();
    ...
    public static void nextMap() {
        ...
        if (level < 4) {
            try {
                audio.audioUpdate("C:\\Users\\Nong Duc Viet Anh\\Desktop\\Bomberman_AADD\\Final\\Final Bomberman\\res\\sound\\level_complete.wav",0);
            } catch (UnsupportedAudioFileException e) {
                e.printStackTrace();
            } catch (IOException e) {
                e.printStackTrace();
